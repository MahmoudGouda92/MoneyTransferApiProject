...
public class AccountsService {
	...
	public Account retrieveBalances(String accountId) {
	...
	public List<Account> retrieveAllBalances() {
	...
	@Transactional
	public void saveAccounts(List<Account> accounts) throws SystemException {
