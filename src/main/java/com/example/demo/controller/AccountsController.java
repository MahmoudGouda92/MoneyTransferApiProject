...
public class AccountsController {
	...
	@GetMapping("/all")
	@ApiOperation(value = "Get All account balance", response = Account.class, produces = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 404, message = "No Accounts found!")})
	public List<Account> getAllBalance() {
		return accountService.retrieveAllBalances();
	}
